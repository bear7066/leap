...
$( document ).ready(function() {
	...
	Leap.loop({}, function(frame) {
        ...
        if(frame.pointables.length > 0){ 
			...
			if (interactionBox && pointable) {
				var normalizedPosition = interactionBox.normalizePoint(pointable.tipPosition, true);
			
				// Rest of your code using 'normalizedPosition'...
			} else {
				console.error('Interaction box or pointable not available in frame.');
			}
			
	        var normalizedPosition = interactionBox.normalizePoint(pointable.tipPosittion, true);
